...
const AdminAuthModal: React.FC<AdminAuthModalProps> = ({ onClose, onSuccess }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-md z-50 flex items-center justify-center p-4" aria-modal="true" role="dialog">
      <div className="w-full max-w-sm bg-[#003366] border border-[#004080] text-white rounded-2xl p-6 md:p-8 flex flex-col animate-fade-in shadow-2xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <input
              ...
              placeholder="••••••••"
              className="w-full px-4 py-3 bg-[#002244] border border-[#004080] text-white placeholder-gray-400 font-poppins text-base rounded-full focus:outline-none focus:ring-2 focus:ring-[#0080ff] transition"
              autoFocus
            />
          </div>
          ...
          <div className="grid grid-cols-2 gap-4 pt-2">
            ...
            <button
              ...
              className="py-3 bg-[#33cc33] text-white font-poppins font-bold text-lg uppercase rounded-full transition-all hover:brightness-110 active:scale-95 disabled:opacity-50 shadow-lg border-b-4 border-[#228822] active:border-b-0 active:translate-y-1"
            >
